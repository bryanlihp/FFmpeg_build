...
5. Config
   * x86 release build: (link with libcmt.lib, MT)
   ...
   ../FFmpegSrc/configure --prefix=../stage/win32/ReleaseMT \
                          ...
                          --extra-ldflags='-LIBPATH:"../libmp3lame/lib/Win32/ReleaseMT"'

   ```
   ffmpeg cmd line:  
   ```
   ../FFmpegSrc/configure --prefix=../stage/win32/ReleaseMT --incdir=../stage/include  --toolchain=msvc --arch=x86 --enable-asm --disable-debug --enable-static --enable-libmp3lame --enable-libopus --extra-cflags='-MT -I"../libmp3lame/include" -DWIN32_LEAN_AND_MEAN' --extra-ldflags='-LIBPATH:"../libmp3lame/lib/Win32/ReleaseMT"'
   ```

  * x86 debug build: (link with libcmtd.lib MTd)
    
   ```
   export PKG_CONFIG_PATH="../libopus/Win32/MTd/lib/pkgconfig":$PKG_CONFIG_PATH 
   AKA: export PKG_CONFIG_PATH="../libopus/Win32/MTd/lib/pkgconfig":/mingw32/lib/pkgconfig:/mingw32/share/pkgconfig
   ...
   ffmpeg cmd line:  
   ```
   ../FFmpegSrc/configure --prefix=../stage/win32/DebugMTd --incdir=../stage/include  --toolchain=msvc --arch=x86 --enable-asm --enable-static --enable-libmp3lame --enable-libopus --extra-cflags='-MTd -I"../libmp3lame/include"'  --extra-ldflags='-LIBPATH:"../libmp3lame/lib/Win32/Debug_MTd"'
   ```
   * x86 release build: (link with msvcrt.lib, MD)
   ```
   export PKG_CONFIG_PATH="../libopus/Win32/MD/lib/pkgconfig":$PKG_CONFIG_PATH 
   AKA: export PKG_CONFIG_PATH="../libopus/Win32/MD/lib/pkgconfig":/mingw32/lib/pkgconfig:/mingw32/share/pkgconfig
   ...
   ffmpeg cmd line:  
   ```
   ../FFmpegSrc/configure --prefix=../stage/win32/ReleaseMD --incdir=../stage/include  --toolchain=msvc --arch=x86 --enable-asm --disable-debug --enable-libmp3lame --enable-libopus --extra-cflags='-MD -I"../libmp3lame/include" -DWIN32_LEAN_AND_MEAN' --extra-ldflags='-LIBPATH:"../libmp3lame/lib/Win32/ReleaseMD"'
   ```

  * x86 debug build: (link with msvcrtd.lib MDd)
    
   ```
   export PKG_CONFIG_PATH="../libopus/Win32/MDd/lib/pkgconfig":$PKG_CONFIG_PATH 
   AKA: export PKG_CONFIG_PATH="../libopus/Win32/MDd/lib/pkgconfig":/mingw32/lib/pkgconfig:/mingw32/share/pkgconfig
